      ...
      return El({
        ...
        children: [
          ...
          El({
            element: "div",
            className:
              "w-[300px] fixed bottom-0 flex justify-center items-center py-4 bg-white rounded-tl-2xl rounded-tr-2xl shadow-2xl",
            children: [
              El({
                element: "button",
                className:
                  " bg-black text-white flex justify-center items-center gap-x-4 rounded-full w-[300px] py-4",
                onclick: () => {
